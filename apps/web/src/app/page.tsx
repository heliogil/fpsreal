  ...
  return (
    <main>
      ...
      >
        ...
        {hero && (
          <div className="rv hero-panel" style={{ position: 'relative', background: 'var(--card)', border: '1px solid var(--accent-dim)', borderRadius: 12, padding: '24px 26px', boxShadow: 'var(--shadow)', animationDelay: '.2s', alignSelf: 'start' }}>
